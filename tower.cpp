...
Spritetower* Spritetower::instance6 = NULL;
Spritetower* Spritetower::instance7 = NULL;
Spritetower* Spritetower::instance8 = NULL;
Spritetower* Spritetower::instance9 = NULL;
Spritetower* Spritetower::instance10 = NULL;
...
Spritetower* Spritetower::getInstance()
{
	...
	if (instance6 == NULL)
	{
		instance6 = new Spritetower();
		instance6->init();
		return instance6;
	}
	if (instance7 == NULL)
	{
		instance7 = new Spritetower();
		instance7->init();
		return instance7;
	}
	if (instance8 == NULL)
	{
		instance8 = new Spritetower();
		instance8->init();
		return instance8;
	}
	if (instance9 == NULL)
	{
		instance9 = new Spritetower();
		instance9->init();
		return instance9;
	}
	if (instance10 == NULL)
	{
		instance10 = new Spritetower();
		instance10->init();
		return instance10;
	}
}
