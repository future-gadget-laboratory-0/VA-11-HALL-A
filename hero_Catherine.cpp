...
void SpriteCatherine::self_strengthen(int dur,int val, __String str)
{
	if (instrengthen = 1)
		return;
	else
	...
	this->schedule(schedule_selector(SpriteCatherine::strengthen), dur, 1, 0);
}
void SpriteCatherine::self_strengthen(int dur, int val1, __String str1, int val2, __String str2)
{
	if (instrengthen = 1)
		return;
	else
...
void SpriteCatherine::self_strengthen(int dur, int val1, __String str1, int val2, __String str2, int val3, __String str3)
{
	if (instrengthen = 1)
		return;
	else
...
void SpriteCatherine::self_strengthen(int dur, int val1, __String str1, int val2, __String str2, int val3, __String str3, int val4, __String str4)
{
	if (instrengthen = 1)
		return;
	else
...
void SpriteCatherine::strengthen(float)
{
	instrengthen = 0;
	this->addproperty(-strength_property_st_num, strength_property_st);
	this->addproperty(-strength_property_nd_num, strength_property_nd);
...
void SpriteCatherine::property_refresh(float)
{
