...
void SpriteRaider::skillnd()
{
	...
	if (stop_judge == 0)
	{
		...
		this->runAction(Repeat::create(animate, 1));
	if (target == NULL || target->get().HP <= 0)
...
void SpriteRaider::skillth(Sprite* m_target)
{
...
void SpriteRaider::skillst(float time)
{
